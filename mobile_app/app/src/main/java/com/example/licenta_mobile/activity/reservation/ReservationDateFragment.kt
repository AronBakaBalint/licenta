...
class ReservationDateFragment : Fragment() {

    private var binding: FragmentReservationDateBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding  = DataBindingUtil.inflate(inflater, R.layout.fragment_reservation_date, container, false)
    ...
    private fun setupObservers() {
        ...
        sharedViewModel.navigateToHourPicker.observe(viewLifecycleOwner, {
